# CustomItem
A library for spawning and giving custom items.

## Usage
Copy this header file into your project:
```h
...
## Examples
You can see various examples of how this can be used in the `examples/` directory in the repository. Feel free to submit PR's for more examples.
